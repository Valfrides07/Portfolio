  ...
  const projects = [
    {
      ...
      description: [
        "Gerador de senhas desenvolvido em HTML, CSS e JavaScript, permitindo a criação de senhas seguras e personalizadas. A aplicação possibilita definir o comprimento da senha e selecionar os tipos de caracteres desejados, incluindo letras maiúsculas, minúsculas, números e símbolos. O projeto também conta com geração aleatória de senha, exibição automática no campo de resultado e funcionalidade de cópia para a área de transferência, facilitando o uso imediato da senha gerada.",
      ],
    ...
    },
    {
      ...
      description: [
        "Interface de login desenvolvida para um projeto fictício de restaurante. A aplicação apresenta uma tela de autenticação simples e elegante, com layout centralizado, animação suave de entrada do formulário e identidade visual inspirada no tema gastronômico. O projeto também inclui navegação para páginas, como cardápio, sobre e política de privacidade, simulando a estrutura básica de um sistema web para restaurantes.",
      ],
  ...
  return (
    <section className={styles.SectionProjetos}>
      ...
      <div className={styles.H1_Projetos}>
        ...
        <p className={styles.InformesGit}>
          {" "}
          Todos códigos usados estão no meu:
          {/* Link externo para o meu github */}
          <a
            className={styles.MeuGithub}
            href="https://github.com/Valfrides07"
            target="_blank"
            rel="noreferrer"
          >
            Github
